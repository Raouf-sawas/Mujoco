...
from ur5.utils.mjcf_utils import string_to_array
from ur5.environments.ur5 import Ur5Env

from ur5.models.arenas import BinsArena
from ur5.models.objects import (
    MilkObject,
    BreadObject,
    CerealObject,
    CanObject,
...
from ur5.models.tasks import PickPlaceTask, UniformRandomSampler


class Ur5PickPlace(Ur5Env):
    def __init__(
            self,
    ...
    def _load_model(self):
        ...
        # The Ur5 robot has a pedestal, we want to align it with the table
...
class Ur5PickPlaceSingle(Ur5PickPlace):
    """
...
class Ur5PickPlaceMilk(Ur5PickPlace):
    """
...
class Ur5PickPlaceBread(Ur5PickPlace):
    """
...
class Ur5PickPlaceCereal(Ur5PickPlace):
    """
...
class Ur5PickPlaceCan(Ur5PickPlace):
    """
