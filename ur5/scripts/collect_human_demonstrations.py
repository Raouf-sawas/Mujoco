...
from ur5.wrappers import DataCollectionWrapper
...
def gather_demonstrations_as_hdf5(directory, out_dir):
    ...
    grp.attrs["repository_version"] = ur5.__version__
...
if __name__ == "__main__":
    ...
    if args.device == "keyboard":
        from ur5.devices import Keyboard
        ...
        from ur5.devices import SpaceMouse
